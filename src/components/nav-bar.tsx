...
export default function Header() {
  return (
    <div className="fixed inset-x-0 md:top-4 top-0 mx-0 md:mx-4 z-40">
      <header
        className={cn(
          "max-w-6xl rounded-none mx-auto flex items-center justify-between md:rounded-2xl px-8 saturate-100 backdrop-blur-md h-16 font-semibold text-sm text-foreground/60 bg-background/75 border border-border/50"
        )}
      >
